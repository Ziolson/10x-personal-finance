...
-   **`GET /api/dashboard`**
    ...
    -   **Response Payload (200 OK)**:
        ```json
        {
          ...
          "expense_by_category": [
            { "category_name": "Groceries", "amount": 800.00, "percentage": 22.8 },
            { "category_name": "Rent", "amount": 2000.00, "percentage": 57.1 },
            { "category_name": "Transport", "amount": 700.00, "percentage": 20.1 }
          ],
          "recent_transactions": [ /* Array of last 5 transaction objects */ ],
          "budget_progress": [
            {
              "budget_id": "uuid",
