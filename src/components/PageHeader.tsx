  ...
  return (
    <header className={cn("flex flex-wrap items-center justify-between gap-4 md:gap-6", className)}>
      <div className="flex-1">
        {description && <p className="text-xs font-semibold uppercase tracking-wider text-neutral-500 dark:text-neutral-400">{description}</p>}
        <h1 className="text-2xl font-semibold text-neutral-900 dark:text-neutral-100 md:text-3xl">{title}</h1>
      </div>
